...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        public IResult Add(IFormFile file, CarImage carImage)
        {
            ...
            return new SuccesResult("Resim Başarıyla Yüklendii");
        }
        ...
        public IResult Delete(CarImage carImage)
        {
            ...
            return new SuccesResult("İlgili aracın ilgili resmi silindi");
        }
        ...
        public IResult Update(IFormFile file, CarImage carImage)
        {
            ...
            return new SuccesResult("İlgili aracın resmi güncellendi!");
        }
        ...
        private IResult CheckIfCarImageLimit(int carId)
        {
            ...
            if (result >= 5)
            {
                return new ErrorResult("Bir araca en fazla 5 fotoğraf yüklenebilir!");
            }
